  ...
  const opportunities = useMemo(() => {
    ...
    return leads
      ...
      .map(lead => {
        ...
        if (lead.gerente_id) {
          signals.push("🛡️ Gerente envolvido");
        }
        if (lead.complexidade_score >= 40) {
          signals.push("🔥 Alta complexidade");
        }
        if (hoursInStage > 48 && score >= 45) {
          signals.push("⏰ Precisa atenção");
        }
        ...
        return {
          ...
          signals,
          category: getOpportunityCategory(score),
        } as Opportunity;
      })
      .filter(o => o.score >= 30)
