...
.anim-fade-up-d1 { animation: fadeUp 0.6s 0.1s ease forwards; opacity: 0; }
.anim-fade-up-d2 { animation: fadeUp 0.5s ease forwards; }
`;
...
export default function Auth() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div
        ...
        style={{
          background: `
            ...
            radial-gradient(ellipse 60% 50% at 80% 80%, rgba(16,185,129,0.07) 0%, transparent 55%),
            radial-gradient(ellipse 40% 40% at 60% 10%, rgba(129,140,248,0.10) 0%, transparent 50%),
            linear-gradient(160deg, #15172a 0%, #0e1020 40%, #111420 100%)
          `,
        }}
      />
      <div
      ...
      {/* ── Fixed logo top-left ── */}
      <div className="fixed top-7 left-12 z-10 flex items-center gap-2.5 anim-fade-up-d2">
        <div
          className="w-9 h-9 rounded-[9px] bg-[#4F46E5] flex items-center justify-center"
          style={{ boxShadow: "0 4px 16px rgba(79,70,229,0.40)" }}
        >
        ...
        <div className="flex flex-col gap-px">
          ...
          <span className="text-[10px] font-medium text-[rgba(240,240,248,0.35)] leading-none flex items-center gap-1">
            Powered by
            <span
              className="inline-block w-[5px] h-[5px] rounded-full bg-[#f59e0b]"
              style={{ boxShadow: "0 0 6px rgba(245,158,11,0.7)", animation: "pulse-dot 2s ease-in-out infinite" }}
            />
            Homi AI
          </span>
        </div>
      ...
      <div className="relative z-[1] grid grid-cols-1 lg:grid-cols-2 h-screen max-w-[1280px] mx-auto px-6 lg:px-12 items-center gap-8 lg:gap-16">
        ...
        <div className="hidden lg:block anim-fade-up">
          {/* Badge */}
          <div
            className="inline-flex items-center gap-1.5 rounded-full px-3 py-[5px] text-[11px] font-semibold uppercase tracking-[0.04em] mb-6"
            style={{
          ...
          {/* Headline */}
          <h1
            className="font-extrabold leading-[1.12] tracking-[-1.5px] text-[#f0f0f8] mb-4"
            style={{ fontSize: "clamp(32px, 3.5vw, 44px)" }}
          >
            A plataforma dos<br />
            <span className="text-[#818cf8]">corretores</span> que<br />
            vendem mais.
          </h1>
      ...
      {/* Card positioned absolutely to stay centered on right col */}
      <div className="absolute inset-0 z-[2] flex items-center justify-center lg:justify-end pointer-events-none">
        <div className="w-full max-w-[420px] lg:mr-[calc((100vw-1280px)/2+48px)] lg:max-w-[420px] pointer-events-auto px-6 lg:px-0"
        ...
        >
          ...
          <div
            className="rounded-[20px] p-9 anim-fade-up-d1"
            style={{
              background: "rgba(255,255,255,0.055)",
              border: "1px solid rgba(255,255,255,0.10)",
              backdropFilter: "blur(24px)",
              boxShadow: "0 0 0 0.5px rgba(255,255,255,0.05) inset, 0 24px 64px rgba(0,0,0,0.35), 0 4px 16px rgba(0,0,0,0.20)",
            }}
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required={!isLogin}
                      className="w-full h-[44px] pl-[38px] pr-3 bg-white/[0.06] border border-white/10 rounded-[10px] text-[14px] text-[#f0f0f8] placeholder:text-[rgba(240,240,248,0.35)] outline-none transition-all focus:border-[#4F46E5] focus:bg-[rgba(79,70,229,0.07)] focus:shadow-[0_0_0_3px_rgba(79,70,229,0.15)]"
              ...
              <div>
                <div className="flex items-center justify-between mb-[7px]">
                  ...
                  {isLogin && (
                    <button type="button" className="text-[12px] font-medium text-[#818cf8] hover:underline transition-colors">
                      Esqueceu?
                    </button>
                  )}
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-[44px] pl-[38px] pr-10 bg-white/[0.06] border border-white/10 rounded-[10px] text-[14px] text-[#f0f0f8] placeholder:text-[rgba(240,240,248,0.35)] outline-none transition-all focus:border-[#4F46E5] focus:bg-[rgba(79,70,229,0.07)] focus:shadow-[0_0_0_3px_rgba(79,70,229,0.15)]"
                    style={{ fontFamily: "inherit" }}
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword((v) => !v)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[rgba(240,240,248,0.35)] hover:text-[rgba(240,240,248,0.55)] transition-colors"
                  >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full h-[46px] bg-[#4F46E5] hover:bg-[#4338CA] text-white text-[14px] font-bold rounded-[10px] flex items-center justify-center gap-2 transition-all disabled:opacity-60 mt-5 hover:-translate-y-px"
                style={{
      ...
      <div className="fixed bottom-6 right-12 z-10 text-[11.5px] text-[rgba(240,240,248,0.35)]">
