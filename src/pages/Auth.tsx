        ...
        <div className="flex flex-col items-center anim-fade-in-scale">
          <div className="relative">
            ...
            <img
              ...
              style={{ height: "160px", clipPath: "inset(10% 0 8% 0)", margin: "-16px 0" }}
            />
          </div>
        </div>

        {/* HEADLINE */}
        <h2 className="text-center text-white/60 text-base font-medium mt-2 mb-6 anim-fade-in-up anim-delay-1">
          Plataforma de performance<br />para corretores imobiliários
        </h2>
