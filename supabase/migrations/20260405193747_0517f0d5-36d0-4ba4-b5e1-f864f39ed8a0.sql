ALTER TABLE public.roleta_distribuicoes ALTER COLUMN janela DROP NOT NULL;
ALTER TABLE public.roleta_distribuicoes ALTER COLUMN janela SET DEFAULT 'dia_todo';

-- Update the RPC to pass janela when inserting
...
BEGIN
  ...
  VALUES (p_lead_id, v_chosen_auth_id, v_segmento_id, v_target_janela)
